...
settextstyle(12,0,5);
setcolor(10);
outtextxy(20,10,"PROJECT CODING DEVELOPED BY Dr. G RAJITHA
DEVI");
setlinestyle(1,0,1);
setcolor(BLUE);
setlinestyle(0,0,3);
...
if(strlen(question)>=40||strlen(ans1)>=25||strlen(ans2)>=25||strlen(
ans3)>= 25||strlen(ans4)>=25)
...
if((x1>=300&&x1<=585&&y1>=420&&y1<=445)||(x1>=0&&x1<=300&&y1>=
450&&y1<=475)||(x1>=300&&x1<=585&&y1>=450&&y1<=475))
sorry();
}
}
} void incorrect2()
...
((x1>=0&&x1<=300&&y1>=420&&y1<=445)||(x1>=0&&x1<=300&&y1>=450
&&y1<=475)||(x1>=300&&x1<=585&&y1>=450&&y1<=475))
sorry();
}
}
}
...
if((x1>=0&&x1<=300&&y1>=420&&y1<=445)||(x1>=300&&x1<=585&&y1>=
420&&y1<=445)||(x1>=300&&x1<=585&&y1>=450&&y1<=475))
sorry();
}
}
}
...
if((x1>=0&&x1<=300)&&(y1>=420&&y1<=445)||(x1>=300&&x1<=585&&y1>
=420&&y1<=445)||(x1>=0&&x1<=300&&y1>=450&&y1<=475))
sorry();
}
}
}
...
int
polygon2[]={300,430,310,420,575,420,585,430,575,445,310,445,300,430};
int polygon3[]={40,465,50,450,290,450,300,465,290,475,50,475,40,465};
int
polygon4[]={300,465,310,450,575,450,585,465,575,475,310,475,300,465};
setcolor(RED);
setfillstyle(1,RED);
setlinestyle(1,0,15);
do
...
settextstyle(12,0,5);
setcolor(10);
outtextxy(510,470,"G RAJITHA DEVI");
setlinestyle(1,0,1);
setcolor(15);
settextstyle(8,0,5);
outtextxy(265,195," E ");
...
settextstyle(0,0,1);
setcolor(7);
outtextxy(0,90,"WELCOME TO THE COMPUTER VERSION OF kaun banega
crorepati");
...
sleep(2);
setcolor(LIGHTGREEN);
outtextxy(0,190,"PLEASE CLICK AND HOLD THE LEFT MOUSE BUTTON TO
SELECT.");
sleep(2);
setcolor(LIGHTGRAY);
outtextxy(0,210,"YOU HAVE 3 LIFELINES(AS INDICATED ON THE UPPER
RIGHT CORNER).");
outtextxy(0,230,"CLICK ON THE LIFELINES TO SELECT THEM.");
sleep(2);
outtextxy(0,250,"THE FILE KBC.TXT IS AN EVER EXPANDABLE QUESTION
BANK..");
outtextxy(0,260,"PLEASE STICK ON TO THE FORMAT USED IN THE FILE
WHILE.. ");
